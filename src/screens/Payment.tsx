              ...
              <Card className="p-6">
                ...
                {method === 'lc' && (
                  <div className="bg-zinc-50 border border-zinc-200 rounded p-4 text-xs text-zinc-700">
                    ...
                    {lcUploaded ? (
                      <div className="mt-3 flex items-center justify-center gap-2 py-2 border border-green-300 bg-green-50 rounded text-green-700 text-xs font-medium">
                        ✓ LC document uploaded — pending verification
                      </div>
                    ) : (
                      <button
                        onClick={() => setLcUploaded(true)}
                        className="mt-3 block w-full py-2 border border-zinc-300 rounded text-zinc-600 hover:border-[#15572A] transition-colors"
                      >
                        Upload LC document
                      </button>
                    )}
